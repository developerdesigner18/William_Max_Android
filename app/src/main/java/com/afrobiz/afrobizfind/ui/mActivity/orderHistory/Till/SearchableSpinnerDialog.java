...
public class SearchableSpinnerDialog<T> extends DialogFragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    private static final String TAG = com.chivorn.smartmaterialspinner.SearchableSpinnerDialog.class.getSimpleName();
    ...
    private SearchableSpinnerDialog.OnSearchDialogEventListener onSearchDialogEventListener;
    private SearchableSpinnerDialog.OnSearchTextChanged onSearchTextChanged;
    private DialogInterface.OnClickListener dialogListener;
    private MySpinner<T> smartMaterialSpinner;
    private boolean isDismissOnSelected = true;

    public SearchableSpinnerDialog() {
    }

    public static SearchableSpinnerDialog newInstance(MySpinner smartMaterialSpinner, List items) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.smartMaterialSpinner = (MySpinner<T>) savedInstanceState.get(INSTANCE_SPINNER_KEY);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            onSearchDialogEventListener = (SearchableSpinnerDialog.OnSearchDialogEventListener) savedInstanceState.getSerializable(INSTANCE_LISTENER_KEY);
        }
