...
public class EventImagesAdapter extends RecyclerView.Adapter<EventImagesAdapter.MyViewHolder>
{
    ...
    public EventImagesAdapter(Context activity, List<EventImage> list)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position)
    {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if(imglist.get(position).getEventimage() != null)
                {
                    ...
                    i_image.putExtra("event", true);
                    context.startActivity(i_image);
//                    Intent i_image = new Intent(context, View_Image.class);
//                    i_image.putExtra("path", imglist.get(position).getEventimage());
//                    context.startActivity(i_image);
                }
            }
        });
