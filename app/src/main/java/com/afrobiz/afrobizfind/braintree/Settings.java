...
public class Settings {
    ...
    private static final String SANDBOX_BASE_SERVER_URL = "http://afrobizfind.com/api/payment/";
    private static final String SANDBOX_TOKENIZATION_KEY = "sandbox_tvhsfz35_ywskmmxn4mt5v5nv";
...
//        return getPreferences(context).getString("customer", "570123311");
//    }

    public static String getCustomerId(Context context)
    {
        return getPreferences(context).getString("customer", "656271631");
    }

//    public static String getMerchantAccountId(Context context) {
//        return getPreferences(context).getString("merchant_account", "Afrobizfind_Wiiliam");
//    }
...
//
    public static String getGooglePaymentCurrency(Context context) {
        return getPreferences(context).getString("google_payment_currency", "GBP");
    }
//
