...
public class UpdateEventImageAdapter extends RecyclerView.Adapter<UpdateEventImageAdapter.MyViewHolder>
{
    ...
    public UpdateEventImageAdapter(AddEventActivity activity, List<EventImage> list)
    {
        this.context1 = null;
...
//    public UpdateEventImageAdapter(AddEventActivity activity, List<Image> list)
//    {
//        this.context = null;
...
//    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position)
    {
        if(context != null)
        {
            Glide.with(this.context).load(imglist.get(position).getEventimage())
            ...
            holder.img_cancel.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    ((AddEventActivity)context).removeForUpdateImage(position);
        ...
        {
            Glide.with(this.context1).load(imglist.get(position).getEventimage())
                    .diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(holder.img_path);
